...
- (void)setStyleLabel{
    ...
    self.font = [UIFont fontWithName:@"MyriadPro-Cond" size:18 ];
...
- (void)setStyleLabelCell{
    ...
    self.font = [UIFont fontWithName:@"MyriadPro-Cond" size:14];
...
- (void)setStyleLabelNameCell{
    ...
    self.font = [UIFont fontWithName:@"MyriadPro-Cond" size:17];
...
- (void)setStyleLabelForChatMassege{
    ...
    self.font = [UIFont fontWithName:@"MyriadPro-Cond" size:10];
...
- (void)setStyleLabelForDate{
    ...
    self.font = [UIFont fontWithName:@"MyriadPro-Cond" size: 9];
...
- (void)setStyleLabelWhisBorderIpad{
    ...
    [[self layer] setCornerRadius:10.0f];
    self.font = [UIFont fontWithName:@"MyriadPro-Cond" size:42];
    self.adjustsFontSizeToFitWidth = YES;
    self.textAlignment = NSTextAlignmentCenter;
