...
- (void)viewDidLoad
{
    ...
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, 483, 320, 85)];
    bottomView.backgroundColor=[UIColor whiteColor];
    UIButton *okBtn = [[UIButton alloc] initWithFrame:CGRectMake(177, 20, 45, 45)];
    [okBtn setBackgroundImage:[UIImage imageNamed:@"ok_crop_btn"] forState:UIControlStateNormal];
    [okBtn addTarget:self action:@selector(done:) forControlEvents:UIControlEventTouchUpInside];
    bottomView.alpha=0.8f;
    [bottomView addSubview:okBtn];
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(112, 20, 45, 45)];
    [cancelBtn setBackgroundImage:[UIImage imageNamed:@"back_crop_btn"] forState:UIControlStateNormal];
    ...
    UILabel *caption = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 320, 60)];
    caption.text = @"Crop An Image";
